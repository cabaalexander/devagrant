...
lnDir(){
  SOURCE=$(normalizePath ${1}) || die "[lnDir] Give me a source dir to make a symlink"
  TARGET_DIRECTORY=$(normalizePath ${2}) || die "[lnDir] What directory do you want this to go?"
